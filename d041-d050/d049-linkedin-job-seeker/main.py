...
# Create a bot that will search for jobs in
# [LinkedIn](https://www.linkedin.com/) and automatically apply to those
# that allow _Easy Apply_.
#
# The project was copied from the resources instead of coded from
# scratch, this because I don't want to apply for jobs at the moment.
