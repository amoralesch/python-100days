...
# Create a bot that logs into Tinder using Facebook account, and then
# automatically _likes_ every profile shown.
#
# This code was copied directly from the solution, as creating our own
# involves owning both a Tinder and Facebook account, and we don't want
# to open accounts for that just for this project.
