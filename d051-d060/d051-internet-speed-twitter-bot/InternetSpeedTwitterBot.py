...
PROMISED_UP = 10
ALERT_THRESHOLD = 0.8
ALERT_DOWN = PROMISED_DOWN * ALERT_THRESHOLD
ALERT_UP = PROMISED_UP * ALERT_THRESHOLD
...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        #     By.ID,
        #     value="_evidon-banner-acceptbutton")
        # accept_button.click()
    ...
    def tweet_at_provider(self):
        if self.up >= ALERT_UP or self.down >= ALERT_DOWN:
            print('Nothng to report, all is good.')
        ...
        email = self.driver.find_element(
            ...
            value='//*[@id="react-root"]/div/div/div[2]/'
                  'main/div/div/div[1]/form/div/div[1]/'
                  'label/div/div[2]/div/input')
        password = self.driver.find_element(
            By.XPATH,
            value='//*[@id="react-root"]/div/div/div[2]/'
                  'main/div/div/div[1]/form/div/div[2]/'
                  'label/div/div[2]/div/input')
        ...
        tweet_compose = self.driver.find_element(
            By.XPATH,
            value='//*[@id="react-root"]/div/div/div[2]/'
                  'main/div/div/div/div/div/div[2]/'
                  'div/div[2]/div[1]/div/div/div/div[2]/'
                  'div[1]/div/div/div/div/div/div/div/div/div/'
                  'div[1]/div/div/div/div[2]/div/div/div/div')

        tweet = (f"Hey Internet Provider, "
                 f"why is my internet speed {self.down}down/{self.up}up "
