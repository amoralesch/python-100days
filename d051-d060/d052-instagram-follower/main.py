...
# Create a bot that find someone in Instagram, and then follow all the
# people that follows the original account.
#
# As I don't want to open an Instagram account just for this project,
# the code is taken exactly from the solution, and just formatted.
...
class InstaFollower:
    ...
    def find_followers(self):
        ...
        time.sleep(8.2)
        # The xpath of the modal will change over time.
        ...
        for i in range(5):
            # In this case we're executing some Javascript, that's what
            # the execute_script() method does.
            # The method can accept the script as well as an HTML element.
            # The modal in this case, becomes the arguments[0] in the script.
            # Then we're using Javascript to say:
            #  "scroll the top of the modal (popup) element
    ...
    def follow(self):
        # Check and update the (CSS) Selector for the
        # "Follow" buttons as required.
        ...
        for button in all_buttons:
            try:
                button.click()
                time.sleep(1.1)
            # Clicking button for someone who is already being
            # followed will trigger dialog to Unfollow/Cancel
